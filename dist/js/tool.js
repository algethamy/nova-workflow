...
Nova.booting(function (Vue, router) {
    Vue.component('workflow', __webpack_require__(2));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      errors: new __WEBPACK_IMPORTED_MODULE_2_laravel_nova__["Errors"](),
      action_component: [],
  ...
  methods: {
    close: function close(transaction) {
      this.transactions[transaction] = false;

      this.$emit('close');
    },
    classes: function classes(transaction) {
      return this.field.styles[transaction];
    },
    reasons: function reasons(transaction) {
      try {
    ...
    actions: function actions(transaction) {
      try {
    ...
    actionFormData: function actionFormData() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.tap(new FormData(), function (formData) {
        formData.append('resources', _this.selectedResources);

        __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.each(_this.action_component.fields, function (field) {
          field.fill(formData);
        });
      });
    },
    ...
    executeAction: function executeAction() {
      ...
      Nova.request({
        ...
        _this2.confirmActionModalOpened = false;
        _this2.handleActionResponse(response.data);
        ...
        if (error.response.status == 422) {
          _this2.errors = new __WEBPACK_IMPORTED_MODULE_2_laravel_nova__["Errors"](error.response.data.errors);
        }
      });
    },
    ...
    action: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(transaction) {
        var self, slug;
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                self = this, slug = this.field.workflow + '/' + this.resourceId + '/' + transaction.replace(/\s/g, '_') + '/' + this.reason;
                _context.next = 3;
                return Nova.request().get('/nova-vendor/workflow/' + slug);
    ...
    openModal: function openModal(transaction) {
...
var render = function() {
  ...
  return Object.keys(_vm.transactions).length > 0
    ? _c(
        "div",
        { staticClass: "flex" },
        [
          _c(
            ...
            [
              _vm.confirmActionModalOpened
                ? _c(_vm.action_component.component, {
                    tag: "component",
                    attrs: {
                      working: _vm.working,
                      "selected-resources": _vm.selectedResources,
                      "resource-name": _vm.resourceName,
                      action: _vm.action_component,
                      errors: _vm.errors
                    },
                    on: {
          ...
          _vm._v(" "),
          _vm._l(_vm.transactions, function(showModal, transaction) {
            return _c(
              "div",
              { staticClass: "flex-1 m-1" },
              [
                _c(
                  "button",
                  {
                    staticClass: "bg-50 w-full btn m-1 p-2 rounded",
                    class: _vm.classes(transaction),
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        _vm.openModal(transaction)
                      }
                    }
                  },
                  [_vm._v("\n      " + _vm._s(transaction) + "\n    ")]
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(
                                          _vm.__("Choose one of the reasons")
                                        )
                                      )
                                    ]
                                  ),
                                  ...
                                  _c(
                                    ...
                                    [
                                      _vm.reasons(transaction) != "textarea"
                                        ? _c(
                                            "select",
                                            {
                                              directives: [
                                        ...
                                        : _c("textarea", {
                                            ...
                                            staticClass:
                                              "form-control form-input-bordered h-auto w-full",
